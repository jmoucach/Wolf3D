...
/*   Updated: 2019/10/09 15:21:53 by jmoucach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void draw_fov(t_data *data)
{
	...
	fov = - player.fov /2;
	l = data->box_length;
		drawline(player.screen_pos, (t_point){player.screen_pos.x + l * cos(player.angle), player.screen_pos.y + l * sin(player.angle)}, data, 0);
